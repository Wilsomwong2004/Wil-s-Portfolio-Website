...
const ModernPortfolioChatbot = () => {
  const [messages, setMessages] = useState([
    {
      id: 1,
      content: "Hi! I'm here to help you explore Wilsomwong's portfolio. Ask me about projects, skills, or experience!",
      sender: 'assistant',
  ...
  const callGeminiAPI = async (userMessage) => {
    ...
    try {
      const response = await fetch(
        `https://generativelanguage.googleapis.com/v1/models/gemini-1.5-flash:generateContent?key=${GEMINI_API_KEY}`,
        {
          ...
          body: JSON.stringify({
            contents: [{
              parts: [{
                text: `You are a helpful assistant for Wilsomwong's portfolio. Answer questions about:

                Profile: Wong Wei Sheng (Wilsomwong), a passionate student currently interning in web development in Kuala Lumpur.
                ...
                Experience: Currently interning as a web developer, focusing on frontend development and creating engaging web experiences.
                ...
                Contact: wilsomwong040727@gmail.com
      ...
      const mockResponses = {
        'projects': "I've worked on several exciting projects including web applications with React, Python automation tools, and mobile-responsive designs. Each project showcases different aspects of full-stack development and problem-solving skills.",
        'skills': "My technical stack includes Python, C/C++, Java, HTML/CSS, JavaScript, and React. I specialize in frontend development and love creating beautiful, interactive user interfaces.",
        'experience': "Currently interning as a web developer in Kuala Lumpur, focusing on frontend development. I'm passionate about creating engaging web experiences and always eager to learn new technologies.",
        'contact': "Feel free to reach out at wilsomwong040727@gmail.com. I'm always open to discussing new opportunities and collaborations!",
        'background': "I'm Wong Wei Sheng (Wilsomwong), a passionate student currently interning in web development. Based in Kuala Lumpur, I love frontend development and creating amazing user experiences.",
        'default': "That's a great question! I'd love to help you learn more about my portfolio. Feel free to ask about specific projects, technologies I use, or my development journey."
      };
    ...
    <div className="fixed bottom-6 right-6 z-50">
      {apiKeyError && (
        <div className="mb-4 p-3 bg-yellow-500/90 backdrop-blur-md text-white rounded-lg text-sm">
          ⚠️ Add REACT_APP_GEMINI_API_KEY to your .env file
        </div>
      )}
              ...
              >
                ...
                <div className={`max-w-[80%] ${
                  ...
                  <div className={`p-3 rounded-2xl backdrop-blur-md ${
                    ...
                    {message.sender === 'assistant' && index === messages.length - 1 && !isTyping ? (
