  ...
  const socialLinks = [
    {
      name: 'GitHub',
      icon: Github,
      href: 'https://github.com/Wilsomwong2004',
      hoverColor: 'hover:text-gray-900'
    },
    {
      name: 'LinkedIn',
      icon: Linkedin,
      href: 'https://www.linkedin.com/in/wilsomwong/',
      hoverColor: 'hover:text-blue-600'
    },
    {
      name: 'Instagram',
      icon: Instagram,
      href: 'https://www.instagram.com/wilsom_ws/',
      hoverColor: 'hover:text-pink-500'
    },
    {
      name: 'Email',
      icon: Mail,
      href: 'mailto:wilsomwong040727@gmail.com',
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="py-12 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-gray-50 hover:text-purple-500">Wilsomwong</h3>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-gray-500">
              ...
              >
                ...
                <span>wilsomwong040727@gmail.com</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 py-6 flex flex-col sm:flex-row justify-between items-center space-y-2 sm:space-y-0">
          <p className="text-sm text-gray-500">
            © {currentYear} Wilsomwong. All rights reserved.
          </p>
